...
현재 1차 구현은 백엔드 Place 등록/승인/조회 흐름과 프론트엔드 지도 조회/장소 등록 흐름까지 완료된 상태입니다. 리뷰, 신고, 숨김/복구, 로그인/JWT는 후속 MVP에서 구현합니다.
...
현재 완료된 구현 범위는 **1차 Place 도메인 + 프론트엔드 지도/장소 등록 구현**입니다.
...
- Place Entity
- PlaceStatus enum: `PENDING`, `APPROVED`, `REJECTED`, `HIDDEN`
- PlaceCategory enum: `RESTAURANT`, `CAFE`, `STUDY_SPACE`, `PRINT_COPY`, `CONVENIENCE`
- Place DTO: `PlaceCreateRequest`, `PlaceResponse`, `PlaceDetailResponse`, `PlaceMapResponse`, `PlaceStatusResponse`
